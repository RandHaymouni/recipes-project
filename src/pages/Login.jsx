                            ...
                            <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div className="relative">
                                    <input
                                        ...
                                        name="email"
                                        type="text"
                                        className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 bg-white focus:outline-none focus:borer-rose-600"
                                ...
                                <div className="relative">
                                    <button
                                        className="bg-indigo-500 text-white rounded-md px-2 py-1 w-24"
                                        type="submit">
                                        Login
                                    </button>
                                </div>
