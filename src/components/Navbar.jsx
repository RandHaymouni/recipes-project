        ...
        <header className='flex shadow-lg bg-white font-[sans-serif] min-h-[70px] fixed z-20 top-0 start-0 w-screen flex-wrap'>
            <div
                ...
                <div className="flex justify-center items-center gap-3 flex-wrap">
                    ...
                    />
                    <p
                        className='text-xl no-underline text-indigo-600 hover:text-blue-dark font-sans font-bold'>
                        Recipes Corner
                    </p>
                </div>
                <div
                    className="bg-gray-100 flex border-2 max-md:order-1 focus-within:border-indigo-500 focus-within:bg-transparent px-4 rounded-sm h-11 lg:w-2/4 max-md:w-full justify-centerS items-center">
                    <svg
